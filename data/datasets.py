...
#         # fn = 'unt_train_leadv_pyramidnet.npy' if train == 'train' else 'unt_test_leadv_pyramidnet.npy'
#         try:
#             dataset = np.load(root_dir, allow_pickle=True).item()
#         except:
#             dataset = np.load(root_dir, allow_pickle=True)
#         self.cln_imgs, self.cln_labs, self.adv_imgs, self.adv_labs, self.true_labs = dataset['cln_img'], dataset[
#             'cln_lab'], dataset['adv_img'], dataset['adv_lab'], dataset['true_lab']
#
...
#         return {"adv_img": adv_img, "cln_img": cln_img, "cln_lab": cln_lab, 'true_lab': true_lab, "adv_lab": adv_lab}
